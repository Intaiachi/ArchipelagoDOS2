...
class DOS2World(World):
    ...
    def fill_slot_data(self) -> Mapping[str, Any]:
        slot_data = self.options.as_dict(
            "goal", "death_link", "syncOption", "deathlinkStyleIn", "deathlinkStyleOut", "hitList", "trapPercentage", "trapStyle", "containerSanity", "randomClassPool", "enableLevelTeleport", "act1Keys", "act2Keys", "act3Keys", "act4Keys", "regionBarriers"
        )
